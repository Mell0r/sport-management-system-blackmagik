...
//        val results: List<ParticipantAndTime> = listOf(
//            sampleParticipants[1]!! to 10,
//            sampleParticipants[2]!! to 20,
//            sampleParticipants[3]!! to null,
//            sampleParticipants[4]!! to 10,
//            sampleParticipants[5]!! to 20,
//            sampleParticipants[6]!! to 20
//        ).map { (participant, time) -> ParticipantAndTime(participant, time?.let{ Time(it) })}
//        val resultFiles =
